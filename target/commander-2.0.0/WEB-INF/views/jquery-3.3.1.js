...
var
	...
	// #7653, #8125, #8152: local com.yiren.rpc.protocol detection
...
jQuery.extend( {
	...
	ajax: function( url, options ) {
		...
		// Add com.yiren.rpc.protocol if not provided (prefilters might expect it)
...
var xhrSuccessStatus = {
		...
		// File com.yiren.rpc.protocol always yields status code 0, assume 200
		0: 200,
							...
							if ( type === "abort" ) {
								...
								if ( typeof xhr.status !== "number" ) {
									...
									complete(
										...
										// File: com.yiren.rpc.protocol always yields status 0; see #8605, #14207
										xhr.status,
										xhr.statusText
									);
								}
